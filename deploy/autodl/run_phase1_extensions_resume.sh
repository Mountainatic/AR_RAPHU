...
for scenario in AR-S4 AR-S5 AR-S6 AR-S7; do
  ...
  run_pool "results/phase1/manifests/${scenario}_G2_XAR_warmup.json"
  run_pool "results/phase1/manifests/${scenario}_G2_XAR_fork.json"
...
echo "AR-S4 through AR-S7 Scheme-A screening completed."
