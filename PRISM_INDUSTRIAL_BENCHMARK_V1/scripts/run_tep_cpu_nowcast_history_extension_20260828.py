...
from prism_benchmark.v211_config import TEP_CPU_NOWCAST_HISTORY_EXTENSION_PROTOCOL
...
DEFAULT_RUN_ROOT = Path(
    "/autodl-pub/data/PRISM_V211_TEP_NOWCAST_H0_W1_HISTORY_128_256_20260828_R1"
)
EXPECTED_PROTOCOL = "TEP_CPU_NOWCAST_HISTORY_L256_V1"
EXPECTED_TASK = "TEP_G_NOWCAST_H0"
EXPECTED_HEAD = "TEP_G_NOWCAST_H0__H0__W1"
...
def run_k(shared: Path, output: Path) -> dict[str, Any]:
    ...
    results = [
        _run_one(
            ...
            view,
            channel,
            TEP_CPU_NOWCAST_HISTORY_EXTENSION_PROTOCOL,
            CONFIG_PATH,
        )
...
def run_pilot(shared: Path, run_root: Path) -> dict[str, Any]:
    ...
    records = [
        run_k_channel(shared, PROJECT, pilot_output, view, fast, TEP_CPU_NOWCAST_HISTORY_EXTENSION_PROTOCOL, CONFIG_PATH),
        run_k_channel(shared, PROJECT, pilot_output, view, medium, TEP_CPU_NOWCAST_HISTORY_EXTENSION_PROTOCOL, CONFIG_PATH),
