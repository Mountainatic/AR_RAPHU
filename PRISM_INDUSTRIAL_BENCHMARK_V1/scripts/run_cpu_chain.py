...
def main() -> None:
    ...
    commands = [
        ...
        ("C5_PRISM_DYNAMIC", [python, str(project / "scripts/run_c5_prism_dynamic.py"), "--shared", str(arguments.shared), "--project", str(project), "--c3-output", str(results / "C3_SYSTEM_IDENTIFICATION"), "--c4-output", str(results / "C4_PRISM"), "--output", str(results / "C5_PRISM_DYNAMIC"), "--n-jobs", str(arguments.c5_jobs)]),
