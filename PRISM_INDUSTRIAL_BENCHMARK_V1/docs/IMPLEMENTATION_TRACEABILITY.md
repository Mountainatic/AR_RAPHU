...
| Hybrid-h/w stagewise K/C/W/A/J ablation | `STAGEWISE_ABLATION_HYBRID_HW_20260904.md`, `stagewise_ablation_hybrid_hw_20260904.json` | `v211_public_all_materialization.py`, `representative_prism_checkpoints.py` | `test_v211_public_all_materialization.py`, `test_portable_checkpoints.py` | stagewise prediction parquets, metrics table, gain bootstrap and admission-status audit | IMPLEMENTED_NOT_YET_FORMALLY_RUN |
