...
|---|---|---|---|---|---|
| Five-dataset source/hash/license freeze | Master 3, 12; CPU 2, C0 | `src/prism_benchmark/stage0.py` | `test_stage0.py` | `dataset_registry/*` | NOT_STARTED |
| Cadence and run/profile/month boundaries | Master 3, 9; CPU 2 | `stage0.py` | `test_stage0.py` | `CADENCE_AUDIT.json`, `RUN_BOUNDARIES.csv` | NOT_STARTED |
