...
The private runner did not upload anything automatically. This repository copy contains only sanitized aggregate artifacts; the workbook and sample-level outputs are excluded.

## Formal target-rod metrics

| direction | information_set | rows | rmse_delta | mae_delta | r2_delta | r2_level_reconstructed | persistence_skill_mse |
|---|---|---|---|---|---|---|---|
