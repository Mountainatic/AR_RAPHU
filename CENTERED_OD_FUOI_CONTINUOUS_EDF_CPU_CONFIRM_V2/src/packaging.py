...
PACKAGE = "CENTERED_OD_FUOI_CONTINUOUS_EDF_CPU_CONFIRM_V2_RESULTS"
...
def build_bundle(
    ...
    *,
    ...
    include = [
        ...
        "CENTERED_OD_FUOI_CONTINUOUS_EDF_CPU_CONFIRM_V2_EXPERIMENT_PLAN.md",
